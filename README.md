<p align="center">
  <img src="https://raw.githubusercontent.com/adsathye/synctx/main/logo.png" alt="Synctx" width="200">
</p>
...
<p align="center">
  <a href="#quick-start"><img src="https://img.shields.io/badge/version-1.0.0-blue.svg" alt="Version"></a>
...
> **[Read the full Guide →](https://github.com/adsathye/synctx/blob/main/GUIDE.md)**
>
...
Contributions are welcome! See [CONTRIBUTING.md](https://github.com/adsathye/synctx/blob/main/CONTRIBUTING.md) for guidelines.

This project follows the [Contributor Covenant Code of Conduct](https://github.com/adsathye/synctx/blob/main/CODE_OF_CONDUCT.md).

For security vulnerabilities, see [SECURITY.md](https://github.com/adsathye/synctx/blob/main/SECURITY.md).

---

## License

This project is licensed under the MIT License — see the [LICENSE](https://github.com/adsathye/synctx/blob/main/LICENSE) file for details.
